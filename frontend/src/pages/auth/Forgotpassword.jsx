...
export default function ForgotPassword({ onClose }) {
    ...
    useEffect(()=>{
        ...
        const i=setInterval(()=>{
            setResendTimer(t=>{
                if(t<=1){clearInterval(i);setCanResend(true);return 0;}
                return t-1;
            });
        },1000);
    ...
    const resetValid = passwordValid && match;

    const handleReset=(e)=>{
        e.preventDefault();
        if(!resetValid){
            setResetError("Fix password");
            return;
        }
        setResetLoading(true);
        setTimeout(()=>{
            ...
            <div className={`fp-card ${animating?"fp-card--exit":"fp-card--enter"}`}>
                    ...
                    <div className="fp-body">
                        ...
                        <form onSubmit={handleGetOtp}>
                            <div className="fp-input-group">
                                <span className="fp-input-icon">
                                    <Mail01Icon size={18} color="#94a3b8"/>
                                </span>
                                <input
                                    className="fp-input"
                                    value={email}
                ...
                {step===STEP_OTP && (
                    <div className="fp-body">
                        ...
                        <button className="fp-back-link" onClick={()=>goTo(STEP_EMAIL)}>
                            <ArrowLeft02Icon size={14}/> Change Email
                        </button>
                    </div>
                )}
                ...
                {step===STEP_RESET && (
                    <div className="fp-body">
                        ...
                        <form onSubmit={handleReset}>
                            ...
                            {confirmPassword && (
                                <p className="fp-match-msg">
                                    {match ? <CheckmarkCircle02Icon size={12}/> : "✖"} 
                ...
                {step===STEP_DONE && (
                    <div className="fp-body">
                        <div className="fp-success-ring">
                            <CheckmarkCircle02Icon size={32} color="white"/>
                        </div>
